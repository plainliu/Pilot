...
namespace Pilot
{
    void PDOFPass::initialize(VkRenderPass render_pass, VkImageView input_attachment)
    {
    ...
    void PDOFPass::setupDescriptorSetLayout()
    {
    ...
    void PDOFPass::setupPipelines()
    {
        ...
        VkShaderModule frag_shader_module =
            PVulkanUtil::createShaderModule(m_p_vulkan_context->_device, DOF_FRAG);
        ...
        pipelineInfo.subpass             = _main_camera_subpass_dof;
    ...
    void PDOFPass::setupDescriptorSet()
    {
    ...
    void PDOFPass::updateAfterFramebufferRecreate(VkImageView input_attachment)
    {
    ...
    void PDOFPass::draw()
    {
        if (m_render_config._enable_debug_untils_label)
        {
            VkDebugUtilsLabelEXT label_info = {
                VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT, NULL, "DOF", {1.0f, 1.0f, 1.0f, 1.0f}};
